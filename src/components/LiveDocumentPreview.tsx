...
import { Download, Printer, FileText, Layers, ArrowLeft, Edit3, PenTool } from 'lucide-react';
...
export const LiveDocumentPreview: React.FC<LiveDocumentPreviewProps> = ({ 
  ...
  return (
    <div className="space-y-4">
      {/* Top Banner with Quick Actions & Navigation */}
      <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-xs flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          {isAdmin && onEditThisReport && (
            <button
              id="btn-preview-switch-edit"
              onClick={onEditThisReport}
        ...
        <div className="grid grid-cols-2 gap-8 pb-4 text-center">
          <div>
            ...
            <p className="mt-2 text-[13px] text-slate-800">
              <span>Số:</span> {report.so_van_ban ? `${report.so_van_ban}/VHIALY` : '       /VHIALY'}
            </p>
          </div>
